        ...
        {mode === "home" ? (
          <div className="flex flex-col gap-4 w-full max-w-sm">
            <button
              ...
              className="group flex items-center gap-4 bg-uno-red text-uno-cream rounded-card px-5 py-4 border-2 border-uno-ink/15 shadow-[0_5px_0_rgba(43,42,39,0.25)] active:translate-y-[3px] active:shadow-none transition"
            >
              <span className="grid place-items-center w-9 h-9 rounded-[12px] bg-uno-cream text-uno-red">
                <PlusIcon />
              </span>
            ...
            <button
              ...
              className="group flex items-center gap-4 bg-uno-blue text-uno-cream rounded-card px-5 py-4 border-2 border-uno-ink/15 shadow-[0_5px_0_rgba(43,42,39,0.25)] active:translate-y-[3px] active:shadow-none transition"
            >
              <span className="grid place-items-center w-9 h-9 rounded-[12px] bg-uno-cream text-uno-blue">
                <PeopleIcon />
              </span>
              <span className="font-extrabold text-xl tracking-wide uppercase">
                Join Room
          ...
          <div className="flex flex-col gap-3 w-full max-w-sm bg-uno-cream/95 rounded-card border-2 border-uno-ink/15 p-5 shadow-[0_5px_0_rgba(43,42,39,0.2)]">
            ...
            <button
              ...
              className="bg-uno-green text-uno-cream font-extrabold text-lg tracking-wide uppercase rounded-card py-3 border-2 border-uno-ink/15 shadow-[0_5px_0_rgba(43,42,39,0.25)] active:translate-y-[3px] active:shadow-none disabled:opacity-40 disabled:shadow-none transition"
            >
              Join
            </button>
            <button
              onClick={() => setMode("home")}
              className="text-uno-ink1 hover:text-uno-ink text-sm font-medium mt-1"
            >
              ← back
            </button>
          </div>
